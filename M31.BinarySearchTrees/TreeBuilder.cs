...
public class TreeBuilder<T>
{
    ...
    public static Node<T> BuildNode(T value, Func<TreeBuilder<T>, TreeBuilder<T>>? buildTree = null)
    {
    ...
    {
        return new BinarySearchTree<T>(BuildNode(value, buildTree));
    }
    ...
    {
        return new BinarySearchTree<T>(BuildNode(value, buildTree), comparer);
    }
